...
class ArosController extends AclAppController
{
	...
	function update_user_role()
	{
	    ...
	    {
	        $this->Session->setFlash(__d('acl', 'Đã cập nhật', true), 'flash_message', null, 'plugin_acl');
	    }
	    else
	    {
	        $errors = array_merge(array(__d('acl', 'Chưa cập nhật được', true)), $this->{$user_model_name}->validationErrors);
