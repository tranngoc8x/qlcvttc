...
function register_user_toggle_right(start_granted, app_root_url, span_id, user_id, plugin, controller, action)
{
	if(start_granted)
	{
		var url1 = app_root_url + "acl/aros/deny_user_permission/" + user_id + "/plugin:" + plugin + "/controller:" + controller + "/action:" + action;
		var url2 = app_root_url + "acl/aros/grant_user_permission/" + user_id + "/plugin:" + plugin + "/controller:" + controller + "/action:" + action;
	}
	else
	{
...
function register_role_toggle_right(start_granted, app_root_url, span_id, role_id, plugin, controller, action)
{
	if(start_granted)
	{
		var url1 = app_root_url + "acl/aros/deny_role_permission/" + role_id + "/plugin:" + plugin + "/controller:" + controller + "/action:" + action;
		var url2 = app_root_url + "acl/aros/grant_role_permission/" + role_id + "/plugin:" + plugin + "/controller:" + controller + "/action:" + action;
	}
	else
	{
