...
<div>
	...
	<?php
	echo $this->Html->link($this->Html->image('/acl/img/design/cross.png') . ' ' . __d('acl', 'Xóa bảng phân quyền', true), '/acl/aros/empty_permissions', array('confirm' => __d('acl', 'Bạn có chắc chắn muốn xóa tất cả quyền người dùng và quyền nhóm ?', true), 'escape' => false));
	?>
...
<tr>
	<th></th>
	<th><?php echo __d('acl', 'Cho phép truy cập vào<em> tất cả các chức năng</em>', true); ?></th>
	<th><?php echo __d('acl', 'Từ chối truy cập vào<em> tất cả các chức năng</em>', true); ?></th>
</tr>
